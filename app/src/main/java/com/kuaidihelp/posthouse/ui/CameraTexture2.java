...
public class CameraTexture2 extends TextureView implements  RqEngineer.Listener{
    ...
    private static final int MAX_PREVIEW_WIDTH = 1280;//Camera2 API 保证的最大预览宽高
...
/*        int width = 160;
    ...
    public void onResume(Activity activity) {
        mCode = " ";//防止最后个存图被删除后，第一个存图还是那个条码会不存图。
    ...
    private void configureTransform(int viewWidth, int viewHeight) {
        ...
        int rotation = activity.getWindowManager().getDefaultDisplay().getRotation()+1;//更改相机预览方向
