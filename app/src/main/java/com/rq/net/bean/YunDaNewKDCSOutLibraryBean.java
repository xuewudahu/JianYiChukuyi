...
public class YunDaNewKDCSOutLibraryBean
{
    private String action;
    private String appid;
    private String appver;
    private YunDaKDCSUploadBean data;
    ...
    public YunDaKDCSUploadBean getData() {
        return this.data;
    }
    ...
    public void setData(final YunDaKDCSUploadBean data) {
        this.data = data;
    }
